...
typedef Parameters = {
    ...
    */
    var ?widget_referrer : Int;
}

enum abstract PlaybackQuality(String) to String {
    var small;
    var medium;
    var large;
    var hd720;
